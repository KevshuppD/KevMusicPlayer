...
class BackupManager(
    ...
    suspend fun exportBackup(
        ...
        if (includeSettings) {
            ...
            settingsJson.put("enable_card_transparency", settingsPrefs.getBoolean("enable_card_transparency", true))
            settingsJson.put("enable_navbar_transparency", settingsPrefs.getBoolean("enable_navbar_transparency", true))
    ...
    suspend fun importBackup(
        ...
        if (json.has("settings")) {
            ...
            if (settingsJson.has("enable_card_transparency")) edit.putBoolean("enable_card_transparency", settingsJson.getBoolean("enable_card_transparency"))
            if (settingsJson.has("enable_navbar_transparency")) edit.putBoolean("enable_navbar_transparency", settingsJson.getBoolean("enable_navbar_transparency"))
